...
public class Loader {
    private static final String PATH_TO_FILE = "src/fifthLesson/assets/weather_table.csv";
    private static final String PATH_TO_OUTPUT_FILE = "src/fifthLesson/assets/output.txt";
    ...
    public static void processWeatherInfoFromFile(String srcFilePath, String targetFilePath) throws Exception {
        ...
        //Если файла нет - создаем (поговорим подробнее на некст занятии)
        if (!file.exists()) {
            file.createNewFile();
        }
